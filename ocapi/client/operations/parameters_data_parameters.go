...
/* ParametersDataParams contains all the parameters to send to the API endpoint
   for the parameters data operation.
...
// WithDefaults hydrates default values in the parameters data params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ParametersDataParams) WithDefaults() *ParametersDataParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the parameters data params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ParametersDataParams) SetDefaults() {
