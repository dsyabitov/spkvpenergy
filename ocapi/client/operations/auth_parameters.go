...
// WithBody adds the body to the auth params
func (o *AuthParams) WithBody(body *models.AuthOpen) *AuthParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the auth params
func (o *AuthParams) SetBody(body *models.AuthOpen) {
	o.Body = body
}
